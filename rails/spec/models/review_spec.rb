...
RSpec.describe Review, type: :model do
  ...
  it "get latest review" do
    ...
    review2 = create(:review, user: user, product: product, created_at: Time.zone.now + 1.day)
    review3 = create(:review, user: user, product: product, created_at: Time.zone.now - 1.day)
  ...
  it "get reviews associated with product" do
    ...
    review3 = create(:review, user: user, product: product1)
  ...
  it "get unreported reviews" do
    ...
    report1 = create(:report, user: user, review: review1)
    report2 = create(:report, user: user1, review: review2)
