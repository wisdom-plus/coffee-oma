...
RSpec.describe Like, type: :model do
  ...
  it "get review_likes accosiated a review " do
    ...
    product_review_like1 = create(:product_review_like, user: user, liked_id: review2.id)
    bean_review_like1 = create(:bean_review_like, user: user, liked_id: bean_review2.id)
