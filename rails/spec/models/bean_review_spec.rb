...
RSpec.describe BeanReview, type: :model do
  ...
  it "get show reviews" do
    ...
    review2 = create(:bean_review, user: user, bean: bean1, title: "review2")
  ...
  it "get rates average" do
    review1 = create(:bean_review, user: user, bean: bean, acidity: 1, bitter: 2, sweet: 3, rich: 4, flavor: 5)
    review2 = create(:bean_review, user: user, bean: bean, acidity: 2, bitter: 2, sweet: 2, rich: 2, flavor: 2)
