...
Brand.create!(
  ...
  logo: File.open('./public/seed/brand/brand-05.png')
)

Brand.create!(
  name: '珈琲サイフォン株式会社',
  website: 'https://coffee-syphon.co.jp/',
  description: "1925年創業の珈琲サイフオン株式会社。世界に先駆けコーヒー�����������������������������イ�����������������������ォ�����を発明・実用化し日本で発売。
...
Brand.create!(
  name: '下村企画',
  website: 'https://www.simomura-kihan.co.jp/',
  description: "「こんなものがほしい」という商品に関するご要望を燕三条のものづくりの技術で商品化。
  機能や形状を考え、モニターを繰り返して使いやすさを確認しています。",
  logo: File.open('./public/seed/brand/brand-09.jpg')
)

Brand.create!(
  name: 'Bialetti',
  website: 'https://bialetti.jp/',
  description: 'イタリア発のビアレッティは機能性と美しさを持った、世界のトップブランドです。',
  logo: File.open('./public/seed/brand/brand-10.png')
)

Brand.create!(
  name: 'bodum',
  website: 'https://www.bodum.com/jp/ja/',
  description: "ボダムは、1944年創業、北欧デンマーク生まれのキッチンウェアブランド。
  “シンプルで美しいデザインと機能性” 長年受け継がれるデザインポリシーに基づいた商品は、世界のデザイン賞を数多く受賞しています。",
  logo: File.open('./public/seed/brand/brand-11.png')
)
...
Product.create!(
  ...
  brand_id: 1,
  tag_list: %W[\u30B3\u30FC\u30D2\u30FC \u30C9\u30EA\u30C3\u30D1\u30FC HARIO V60],
  user_id: 1
)
...
Product.create!(
  ...
  brand_id: 2,
  tag_list: %W[\u30B3\u30FC\u30D2\u30FC \u30AB\u30EA\u30BF \u30C9\u30EA\u30C3\u30D1\u30FC \u30A6\u30A7\u30FC\u30D6\u30C9\u30EA\u30C3\u30D1\u30FC],
  user_id: 3
)
Product.create!(
  ...
  brand_id: 1,
  tag_list: %W[\u30B3\u30FC\u30D2\u30FC \u30B9\u30B1\u30FC\u30EB HARIO V60],
  user_id: 4
)
Product.create!(
...
Product.create!(
  ...
  brand_id: 2,
  tag_list: ['コーヒー', '���リタ', 'ウェーブ', 'コーヒーフィルター', 'ホワイト'],
  user_id: 6
)
Product.create!(
  images: [File.open('./public/seed/product-07.jpg')],
  caption: "●抽出温度が一目で分かる温度計が蓋の中央に付いている便利なドリ��プケトル
  ...
  brand_id: 7,
  tag_list: %W[\u30B3\u30FC\u30D2\u30FC \u30C9\u30EA\u30C3\u30D7\u30B1\u30C8\u30EB \u30B7\u30FC\u30D3\u30FC\u30B8\u30E3\u30D1\u30F3
               \u30D6\u30E9\u30C3\u30AF],
  user_id: 7
)
Product.create!(
  ...
  brand_id: 5,
  tag_list: %W[\u30B3\u30FC\u30D2\u30FC \u30B3\u30FC\u30D2\u30FC\u30B9\u30B1\u30FC\u30EB TIMEMORE \u30DB\u30EF\u30A4\u30C8 \u30D6\u30E9\u30C3\u30AF],
  user_id: 8
)
Product.create!(
  ...
  brand_id: 1,
  tag_list: %W[\u30B3\u30FC\u30D2\u30FC \u30B5\u30FC\u30D0\u30FC \u30CF\u30EA\u30AA \u30B3\u30FC\u30D2\u30FC\u30B5\u30FC\u30D0\u30FC V60],
  user_id: 9
)
Product.create!(
  ...
  brand_id: 4,
  tag_list: %W[\u30B3\u30FC\u30D2\u30FC \u30A8\u30A2\u30ED\u30D7\u30EC\u30B9 \u30A8\u30A2\u30ED\u30D7\u30EC\u30B9GO],
  user_id: 10
)
Product.create!(
  ...
  brand_id: 1,
  tag_list: %W[\u30B3\u30FC\u30D2\u30FC HARIO \u30C9\u30EA\u30C3\u30D7\u30DD\u30C3\u30C8 \u30CD\u30EB\u30C9\u30EA\u30C3\u30D7],
  user_id: 11
)
Product.create!(
...
Product.create!(
  ...
  brand_id: 10,
  tag_list: %W[\u30B3\u30FC\u30D2\u30FC BIALETTI \u6C34\u51FA\u3057\u30B3\u30FC\u30D2\u30FC \u30DE\u30AD\u30CD\u30C3\u30BF
               \u30E2\u30AB\u30A8\u30AD\u30B9\u30D7\u30EC\u30B9],
  user_id: 1
)
Product.create!(
  ...
  フィルターは300メッシュ (目の細かい)のポリエステ���を使用。水洗いしてく���返し使える
  サーバーは耐久性に優れる素材を使用。軽量で、落としても割れない
  注いだ量が分かりやすい目盛り付き
  液だれしに���い注ぎ口形状",
  name: '珈琲考具 コーヒーサーバ�� 水出しフィルター付き ',
  price: 2200,
...
Product.create!(
  ...
  brand_id: 2,
  tag_list: %W[\u30B3\u30FC\u30D2\u30FC \u30AB\u30EA\u30BF \u9285\u88FD \u30B3\u30FC\u30D2\u30FC\u30E1\u30B8\u30E3\u30FC],
  user_id: 4
)
Product.create!(
...
Product.create!(
  ...
  brand_id: 6,
  tag_list: %W[\u30B3\u30FC\u30D2\u30FC KONO \u540D\u9580\u30C9\u30EA\u30C3\u30D1\u30FC \u30B3\u30FC\u30D2\u30FC\u30C9\u30EA\u30C3\u30D1\u30FC
               2\u4EBA\u7528],
  user_id: 2
)
Product.create!(
...
Product.create!(
  ...
  brand_id: 8,
  tag_list: %W[\u30B3\u30FC\u30D2\u30FC \u30A4\u30EB\u30AB\u30CA \u30B3\u30FC\u30D2\u30FC\u30C9\u30EA\u30C3\u30D1\u30FC
               \u5BCC\u58EB\u5C71\u30C9\u30EA\u30C3\u30D1\u30FC],
  user_id: 9
)
...
BeanReview.create!(
  ...
  rich: 2,
  sweet: 4,
  title: 'さっぱりとしているが、どちらかとい��と酸っぱめな��イスコーヒー。',
  content: "プレスでアイスコーヒーを抽出
  メイヤーレモンのような柔らかい甘さを持つレモンのフレーバーを感じられる。
  ���クはそこまでなく、コーヒー全体的に軽め。後味はさっぱりで、後味の余韻���気���ちいい。
